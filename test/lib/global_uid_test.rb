  ...
  describe "With GlobalUID" do
    ...
    describe "with per-process_affinity" do
      ...
      it "increment sequentially, selecting a server at random" do
        ...
        refute_empty(GlobalUid::Base.servers[0].allocator.recent_allocations)
        assert_empty(GlobalUid::Base.servers[1].allocator.recent_allocations)
      end
    ...
    describe "without per-process_affinity" do
      ...
      it "increment sequentially, using the first configured id_server" do
        ...
        refute_empty(GlobalUid::Base.servers[0].allocator.recent_allocations)
        refute_empty(GlobalUid::Base.servers[1].allocator.recent_allocations)
      end
    end
